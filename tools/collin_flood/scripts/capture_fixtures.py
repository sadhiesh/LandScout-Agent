"""Capture fixtures from live Collin County floodplain service for offline tests.
...
def capture_fixture(name: str, prop_id: int):
    ...
    try:
        ...
        # Query Collin floodplain
        result = get_collin_floodplain_from_geometry(geometry, parcel_acres=acres)
...
def main():
    ...
    # PROP_ID 46: No floodplain (low risk)
    capture_fixture("prop_id_46_no_floodplain", prop_id=46)
    
    # PROP_ID 1912050: Floodplain (high risk)
    capture_fixture("prop_id_1912050_floodplain", prop_id=1912050)
    
    print("\nCollin floodplain fixture capture complete!")
